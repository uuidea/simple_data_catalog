...
**Tip:** Keep the YAML tidy by using the existing sections as templates. The `generate-datacatalog.sh` script (triggered by CI) will automatically render the Jinja template into the final TTL file.
